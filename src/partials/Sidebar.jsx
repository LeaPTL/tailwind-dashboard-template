...
function Sidebar({
  ...
  // Fermer la sidebar si un clic est détecté en dehors
  useEffect(() => {
  ...
  useEffect(() => {
    const keyHandler = ({ keyCode }) => {
      if (!sidebarOpen || keyCode !== 27) return; // 27 est le code de la touche ESC
      setSidebarOpen(false);
    };
  ...
  return (
    <div className="min-w-fit">
      ...
      <div
        ...
        className={`flex flex-col absolute z-40 left-0 top-0 h-[100dvh] overflow-y-scroll no-scrollbar w-64 shrink-0 bg-white dark:bg-gray-800 p-4 transition-all duration-200 ease-in-out ${sidebarOpen ? "translate-x-0" : "-translate-x-64"} ${variant === 'v2' ? 'border-r border-gray-200 dark:border-gray-700/60' : 'rounded-r-2xl shadow-sm'}`}
      >
        {/* Sidebar header */}
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          {/* logo action sur sidebar */}
          <button
              ref={trigger}
          ...
          >
            ...
            <img className="w-6 h-6 fill-current" src="https://www.svgrepo.com/show/354238/python.svg" alt="Python Icon" width={32} height={32}/>
          </button>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div>
            <h3 className="text-xs uppercase text-gray-400 dark:text-gray-500 font-semibold pl-3">
              ...
              <span className="lg:hidden lg:sidebar-expanded:block 2xl:block">Paramètres</span>
            </h3>
            <ul className="mt-3">
              {/* Dashboard */}
